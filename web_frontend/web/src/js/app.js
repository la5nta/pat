...
import { alert } from './modules/utils';
import { Version } from './modules/version';
import { NotificationService } from './modules/notifications';
import { StatusPopover } from './modules/status-popover';
import { Geolocation } from './modules/geolocation';
import { ConnectModal } from './modules/connect-modal';
import { PromptModal } from './modules/prompt';
import { PasswordRecovery } from './modules/password-recovery/main.js';
import { Mailbox } from './modules/mailbox';
import { Composer } from './modules/composer';
import { FormCatalog } from './modules/form-catalog';
import { Viewer } from './modules/viewer';
import { ProgressBar } from './modules/progress-bar';
import { StatusText } from './modules/status-text';
